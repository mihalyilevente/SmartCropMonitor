...
libdir     = "C:\\Users\\nikit\\PycharmProjects\\SmartCropMonitor\\haskell-service\\.stack-work\\install\\9b6c9856\\lib\\x86_64-windows-ghc-9.6.7\\haskell-service-0.1.0.0-2d6A0mGfPql2E0Iz2Zz1Oo-haskell-service-exe"
...
getLibDir     = catchIO (getEnv "haskell_service_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "haskell_service_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "haskell_service_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "haskell_service_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "haskell_service_sysconfdir") (\_ -> return sysconfdir)
